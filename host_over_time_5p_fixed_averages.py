...
#output_name = '5p_fixed_craton400km_rain0.0002_Km210_Km70_Kf1e-5_vel10_'
...
for p in paths:
    ...
    with open(p) as f:
        ...
        t,source_area,host_area = np.genfromtxt(clean_lines, comments='#', usecols=(0,1,3), delimiter=' ', unpack=True)
