...
output_file_name = "5p_fixed_craton_UC23km"
...
dataframe.to_csv(output_file_name + "_edge" + str(craton_edge) + "_sigma" + str(sigma_polygon) + ".txt",index=False, mode='w', header=False, sep=' ')
