...
output_file_name = "5p_fixed_perturbation_craton_UC23km.txt"
output_file_name = "5p_fixed_craton_UC23km_400km.txt"
...
dataframe.to_csv(output_file_name,index=False, mode='a', header=False, sep=' ')
