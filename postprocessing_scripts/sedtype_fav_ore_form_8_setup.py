...
#    renderView1.ViewSize = [4000, 500] 
    ...
    # save screenshot
    #output_filename=file_name_base+m+'/'+m+'_'+ASPECT_time_steps[t]+'_heatfluxcontours_sedtypes_Tcontours_source_host_sedage2_8_zoom2_setup.png'
    ...
    SaveScreenshot(output_filename, renderView1, ImageResolution=[2560, 1920], #[4000, 500], #test
    ...
    # save screenshot
    #output_filename=file_name_base+m+'/'+m+'_'+ASPECT_time_steps[t]+'_heatfluxcontours_sedtypes_Tcontours_source_host_sedage2_8_wholedomain_setup.png'
