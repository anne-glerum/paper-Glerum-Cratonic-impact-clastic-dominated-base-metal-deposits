...
# Model names
models = [
          '5q_fixed_craton_UC23km_edge400000.0_sigma10000.0.txt',
          '5q_fixed_craton_UC23km_edge450000.0_sigma10000.0.txt',
          '5q_fixed_craton_UC23km_edge500000.0_sigma10000.0.txt',
         ]

output_name = '5q_fixed_comparison_sigma10_'
...
for m in models:
    ...
    plt.plot(x/1e3,topo,color=colors[counter],linestyle='solid',label=labels[counter],fillstyle='none')

    counter += 1


plt.axvline(390, color='grey', linestyle='dotted')
plt.axvline(400, color='black', linestyle='dotted')
plt.axvline(410, color='grey', linestyle='dotted')
plt.axvline(490, color='grey', linestyle='dotted')
plt.axvline(500, color='black', linestyle='dotted')
plt.axvline(510, color='grey', linestyle='dotted')
