...
output_name = '5o_fixed_craton500km_rain0.0001_Km210_Km70_Kf1e-5_vel10_'
...
for p in paths:
    ...
    with open(p) as f:
        ...
        t,marine_sediment_area = np.genfromtxt(clean_lines, comments='#', usecols=(1,63), delimiter=' ', unpack=True)
...
plt.ylabel(r"Marine sediment area [km$\mathbf{^2}$]",weight="bold")
